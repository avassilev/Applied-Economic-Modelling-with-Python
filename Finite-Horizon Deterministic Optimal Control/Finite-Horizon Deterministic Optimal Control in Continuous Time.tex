...
\begin{section}{The maximum principle}\label{sec:max}
	...
	\begin{frame}[fragile]
		...
		\begin{itemize}\itemsep1em
			...
			\item When it is unclear whether the maximum is attained at an interior point, a more general approach to solve the Hamiltonian maximization problem is called for.
		\end{itemize}
	\end{frame}

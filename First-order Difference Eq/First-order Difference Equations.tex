...
\begin{itemize}
	\item There exist fixed points which are neither attractors, nor repellers
...
\begin{itemize}
	...
	\[
		y_{n+m} = y_{n}
	\]
	for some fixed integer $m$ and all $n$. The smallest integer $m$ is called \textbf{the period of the solution}.
\end{itemize}
\begin{defn}
